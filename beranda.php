    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Zahra Mart Tanjungbalai</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Barang Kadaluwarsa</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>Kode.</th><th width="30%">Kode. Barang</th><th>Nama Barang</th><th>Jenis Barang</th><th>Jumlah Barang</th><th>Tanggal Masuk</th><th>Tanggal Kadaluwarsa</th>
                            </tr>
                        </thead>
                        <tbody>
