                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="date" name="tgl_kadaluwarsa" class="form-control" id="inputEmail3" placeholder="Inputkan Tanggal Kadaluwarsa" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="barcode" class="form-control" id="inputPassword3" placeholder="Inputkan Kode Barcode" required>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="supplier" class="form-control" id="inputPassword3" placeholder="Inputkan Supplier Barang" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="harga_beli" class="form-control" id="inputPassword3" placeholder="Inputkan Harga Beli Barang" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="harga_jual" class="form-control" id="inputPassword3" placeholder="Inputkan Harga Jual Barang" required>
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="harga_member" class="form-control" id="inputPassword3" placeholder="Inputkan Harga Member" required>
                            </div>
                        </div>
...
if($_POST){
    ...
    //buat sql
    $sql="INSERT INTO tbl_barang VALUES ('','$kode_barang','$nama_barang','$jenis_barang','$jumlah_barang','$tgl_masuk','$tgl_kadaluwarsa','$barcode','$supplier','$harga_beli','$harga_jual','$harga_member')";
